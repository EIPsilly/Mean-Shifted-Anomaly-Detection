...
def fine_tune_model(center, model, score_net, train_loader, val_loader, test_loader, device, args):
    ...
    for epoch in range(args.ft_epochs):
        ...
        for (idx, img1, augimg, label, domain_labels) in tqdm(train_loader, desc='Train...'):
            ...
            if args.lambda1 == 1:
                ...
                loss = L_CL + L_mmd + torch.nn.CrossEntropyLoss()(scores, label)
            # CrossEntropyLoss
...
def main(args):
    ...
    fine_tune_model(center, model, score_net, train_loader, val_loader, test_loader, device, args)
